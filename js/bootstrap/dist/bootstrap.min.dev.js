...
+function (t) {
  ...
  i.VERSION = "3.3.5", i.RESET = "affix affix-top affix-bottom", i.DEFAULTS = {
    ...
    if (this.$element.is(":visible")) {
      ...
      "object" != _typeof(s) && (o = n = s), "function" == typeof n && (n = s.top(this.$element)), "function" == typeof o && (o = s.bottom(this.$element));
  ...
  function i(e) {
    return this.each(function () {
      var i = t(this),
          ...
          o = t.extend({}, s.DEFAULTS, i.data(), "object" == _typeof(e) && e);
